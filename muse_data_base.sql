...
CREATE TABLE IF NOT EXISTS perf_album (id serial PRIMARY KEY,

perf_id integer REFERENCES performer(id), album_id integer REFERENCES album(id));

CREATE TABLE IF NOT EXISTS perf_genre (id serial PRIMARY KEY,

perf_id integer REFERENCES performer(id), genre_id integer REFERENCES genre(id));

CREATE TABLE IF NOT EXISTS track_collection (id serial PRIMARY KEY,
